...
<details>
  ...
  if llm:
      # This prompt template requires an `agent_scratchpad` for the agent's internal steps.
      ...
      # The 'tools' argument is already bound to the agent, but passed here for the executor.
